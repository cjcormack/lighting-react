 ...
 * Spread…*, *Save as Look… · Live · Apply* — generalised. A footer is drawn only where a panel
 * writes on **Apply** rather than as it is edited: the text and address editors on the sheets,
 * where a half-typed name is not a value anyone wants written; never the level, position or
 * setting editors, which write as they go and have nothing left to apply.
 *
 ...
 * The rule and the top padding are the footer's; a host that docks it full-bleed says so at its
 * import, as the two busk tabs do with their own `px-3 py-2`.
 */
