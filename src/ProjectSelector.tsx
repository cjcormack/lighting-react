        ...
        {activeProject && (
          <>
            ...
            <NavItem
              ...
              label="Fixtures"
              isActive={location.pathname.startsWith("/fixtures") || location.pathname.includes("/fixtures")}
              collapsed
            ...
            <NavItem
              ...
              label="Groups"
              isActive={location.pathname.startsWith("/groups") || location.pathname.includes("/groups")}
              collapsed
